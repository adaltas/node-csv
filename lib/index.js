...
Stringifier = class Stringifier extends stream.Transform {
  ...
  _transform(chunk, encoding, callback) {
    ...
    if (!(Array.isArray(chunk) || typeof chunk === 'object')) { //and chunk isnt null
  ...
  stringify(record) {
    var _record, column, columns, containsEscape, containsQuote, containsRowDelimiter, containsdelimiter, delimiter, err, escape, i, j, l, newrecord, quote, quoted, quotedMatch, quotedString, ref, ref1, regexp, shouldQuote, value;
    if (typeof record !== 'object') {
      return record;
    }
    ({columns, delimiter, quote, escape} = this.options);
  ...
  cast(value) {
    ...
    try {
      if (type === 'string') {
        ...
        return [void 0, this.options.cast.string(value)];
      } else if (type === 'number') {
        return [void 0, this.options.cast.number(value)];
      } else if (type === 'boolean') {
        return [void 0, this.options.cast.boolean(value)];
      } else if (value instanceof Date) {
        return [void 0, this.options.cast.date(value)];
      } else if (type === 'object' && value !== null) {
        return [void 0, this.options.cast.object(value)];
      } else {
        return [void 0, value];
      }
    } catch (error) {
