...
Stringifier = function(options) {
  ...
  if ((_base7 = this.options).flags == null) {
    _base7.flags = 'w';
  }
  if ((_base8 = this.options).encoding == null) {
    _base8.encoding = 'utf8';
  }
  if ((_base9 = this.options).newColumns == null) {
    _base9.newColumns = false;
  }
  if ((_base10 = this.options).end == null) {
    _base10.end = true;
  }
  if ((_base11 = this.options).eof == null) {
    _base11.eof = false;
  }
  if ((_base12 = this.options).rowDelimiter == null) {
    _base12.rowDelimiter = '\n';
  }
