...
module.exports = function() {
  var callback, data, error, options, result, transform, udf;
  if (arguments.length === 1) {
    udf = arguments[0];
  }
  if (arguments.length === 2) {
    if (typeof arguments[0] === 'function') {
      udf = arguments[0], options = arguments[1];
    } else {
      data = arguments[0], udf = arguments[1];
    }
  }
  if (arguments.length === 3) {
    if (typeof arguments[2] === 'function') {
      ...
      data = arguments[0], udf = arguments[1], options = arguments[2];
    }
