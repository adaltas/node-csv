...
Stringifier = function(opts = {}) {
  var base, base1, base10, base11, base12, base13, base14, base2, base3, base4, base5, base6, base7, base8, base9, isRegExp, isString, j, k, len, options, quoted_match, ref, v;
  // Immutable options
  options = {};
  for (k in opts) {
    v = opts[k];
