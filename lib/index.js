...
Transformer.prototype.transform = function(options, cb) {
      ...
      if (transform.length === 2) {
        _results.push(transform.call(null, chunk, (function(_this) {
          return function(err, chunk) {
            return _this._done(err, chunk, cb);
          };
        })(this)));
      } else {
...
Transformer.prototype._done = function(err, chunk, cb) {
  this.running--;
  if (err) {
...
module.exports = function(udf, options) {
  var callback, data, result, transform;
