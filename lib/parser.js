...
Parser.prototype.write = function(chars, end) {
  ...
  while (i < l) {
    ...
    console.log(JSON.stringify(this.options.escape), JSON.stringify(chars.substr(i, this.options.escape.length)), i, '+', this.options.escape.length, l, (i + this.options.escape.length >= l && chars.substr(i, this.options.escape.length) !== this.options.escape) && !end);
