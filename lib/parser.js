...
Parser.prototype.parse = function(chars) {
  var areNextCharsRowDelimiters, c, csv, escapeIsQuote, i, isEscape, isQuote, isReallyEscaped, l, nextChar;
  csv = this.csv;
  chars = '' + chars;
  l = chars.length;
  i = 0;
  ...
  while (i < l) {
    ...
    if (c === this.options.escape || c === this.options.quote) {
      ...
      this.state.field += c;
    } else if (c === this.options.delimiter) {
