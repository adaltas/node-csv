...
stringify = require('csv-stringify/lib/sync'); // ## `csv.generate()`
// Reference the CSV generator, alias to `require('csv-generate')`.

module.exports.generate = generate; // ## `csv.parse()`
// Reference the CSV parser, alias to `require('csv-parse')`.

module.exports.parse = parse; // ## `csv.transform()`
// Reference the stream transformer, alias to `require('stream-transform')`.

module.exports.transform = transform; // ## `csv.stringify()`
