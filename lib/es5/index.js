...
function (_stream$Transform) {
  ...
  _createClass(Stringifier, [{
    ...
    value: function stringify(chunk) {
      var column, columns, containsEscape, containsQuote, containsRowDelimiter, containsdelimiter, csvrecord, delimiter, err, escape, field, header, i, j, l, len, m, quote, quoted, quotedMatch, quotedString, record, ref, ref1, regexp, shouldQuote, value;
