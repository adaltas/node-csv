...
_Generator = function Generator() {
  ...
  var accepted_header_types, base, base1, base2, base3, base4, base5, base6, base7, base8, base9, i, j, len, ref, v;
  ...
  if ((base8 = this.options).row_delimiter == null) {
    base8.row_delimiter = '\n';
  }
  ...
  if (this.options.eof === true) {
    this.options.eof = this.options.row_delimiter;
  } // State
...
_Generator.prototype._read = function (size) {
  ...
  while (true) {
    ...
    if (this.options.objectMode) {
      ...
      // Stringify the line
      line = "".concat(this._.count_created === 0 ? '' : this.options.row_delimiter).concat(line.join(this.options.delimiter));
