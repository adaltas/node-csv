  ...
  _createClass(Parser, [{
    ...
    value: function __normalizeOptions(opts) {
      ...
      this.state = {
        ...
        options.delimiter.length, // Skip if the remaining buffer can be escape sequence
        1),
    ...
    value: function __needMoreData(i, bufLen, end) {
      ...
      var requiredLength = Math.max(needMoreDataSize, // Skip if the remaining buffer smaller than row delimiter
