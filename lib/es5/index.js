...
var Parser = /*#__PURE__*/function (_Transform) {
  ...
  _createClass(Parser, [{
    ...
    value: function __needMoreData(i, bufLen, end) {
      ...
      quoting ? quote.length + recordDelimiterMaxLength : 0, // Skip if the remaining buffer can be escape sequence
      escape.length, // Skip if the remaining buffer can be delimiter
      delimiter.length);
