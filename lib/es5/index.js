...
_Stringifier = function Stringifier() {
  ...
  var base, base1, base10, base11, base12, base13, base2, base3, base4, base5, base6, base7, base8, base9, k, options, v; // Immutable options
...
module.exports.Stringifier = _Stringifier; // ## `Stringifier.prototype.headers`
...
_Stringifier.prototype.stringify = function (record) {
  ...
  if (Array.isArray(record)) {
    ...
    for (i = l = 0, ref1 = record.length; 0 <= ref1 ? l < ref1 : l > ref1; i = 0 <= ref1 ? ++l : --l) {
      ...
      if (type === 'string') {// fine 99% of the cases, keep going
      } else if (type === 'number') {
