...
_Stringifier = function Stringifier() {
  ...
  if (options.formatters.bool) {
    // Backward compatibility
    options.formatters.boolean = options.formatters.bool;
  } // Custom formatters


  if ((base = options.formatters).string == null) {
    base.string = function (value) {
      return value;
    };
  }

  if ((base1 = options.formatters).date == null) {
  ...
  if ((base2 = options.formatters).boolean == null) {
  ...
  if ((base3 = options.formatters).number == null) {
  ...
  if ((base4 = options.formatters).object == null) {
