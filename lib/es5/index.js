...
var Parser = /*#__PURE__*/function (_Transform) {
  ...
  function Parser() {
    ...
    if (options.quote === null || options.quote === false || options.quote === '') {
      ...
      if (!Buffer.isBuffer(options.quote)) {
        ...
        throw new Error("Invalid Option Length: quote must be one character, got ".concat(options.quote.length)); // }else{
    ...
    _this.state = {
      ...
      escapeIsQuote: Buffer.isBuffer(options.quote) && Buffer.compare(Buffer.from([options.escape]), options.quote) === 0,
  ...
  _createClass(Parser, [{
        ...
        if (this.state.escaping === true) {
          ...
          if (this.state.commenting === false && this.__isQuote(buf, pos)) {
            if (this.state.quoting === true) {
              ...
              if (escape !== null && chr === escape && this.__isQuote(buf, pos + 1)) {
                pos++;
    ...
    value: function __isQuote(buf, pos) {
      ...
      var l = quote.length; // if(quote[0] !== nextChr) return false
